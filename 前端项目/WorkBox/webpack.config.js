...
const swInjConfig = require('./workbox-inj-config')
const swGenConfig = require('./workbox-gen-config')
...
module.exports = {
  ...
  plugins: [
     ...
     */
    new workboxPlugin.GenerateSW(swGenConfig),
    new workboxPlugin.InjectManifest(swInjConfig),
    new HtmlWebpackPlugin({
      filename: 'index.html',
      title: 'webpack workBox',
      template:'src/html/index.html',
      favicon: __dirname + '/src/image/favicon.png',
      hash: true,
    })
  ],
  devServer:{
    ...
    port: 5566, //可选，端口
    contentBase:path.resolve(__dirname,'src/dist'), //可选，基本目录结构
    compress: true, //可选，压缩
    hot: true,
